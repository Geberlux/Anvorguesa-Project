            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                      <a class="nav-link"><?php if(!empty($correo)): ?> <?php echo $correo ?> <?php else: ?><a class="nav-link" href="usuario">Ingresar</a></a> <?php endif; ?>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link"><?php if(!empty($correo)): ?><a class="nav-link" href="usuario/logout">Cerrar Sesión</a> <?php else: ?><a class="nav-link" href="usuarioregistrar">Registrar</a></a> <?php endif; ?>
                  </li>
                </ul>
